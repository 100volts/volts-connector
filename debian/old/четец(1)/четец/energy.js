...
async function readMeters() {
    ...
    try {
      ...
      for (let meter of meters) {
        ...
        volatageMeter.push({
          ...
          energyActyveExport: len2Data[1],
          energyReactyveImport: len2Data[2],
          energyReaktyveExport: len2Data[3],
        ...
        const postMeterData = JSON.stringify({
          ...
          energyActyveExport: len2Data[1].toFixed(2),
          energyReactyveImport: len2Data[2].toFixed(2),
          energyReaktyveExport: len2Data[3].toFixed(4),
  ...
  async function main() {
    ...
    const combined = totalPowerData.map((item) => [
      ...
      item.energyActyveExport,
      item.energyReactyveImport,
      item.energyReaktyveExport,
      item.energyApparent,
    ]);
